...
class CinderSnapshotTests(object):
    ...
    def test_snapshot_create_and_delete(self):
        ...
        self.assert_object_details(self.SNAPSHOT_PROPERTY, snapshot)
        self.object_delete('snapshot', snapshot)
        self.object_delete('volume', volume)

class CinderSnapshotCLITests(base.ClientCLITestBase, CinderSnapshotTests):
    pass


class CinderSnapshotAPITests(base.ClientAPITestBase, CinderSnapshotTests):
    pass
